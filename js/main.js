...
/*===========================================================*/	
 ...
 $(function(){
            ...
            jQuery('.in-slide-content1, .in-slide-content2, .in-slide-content3, .in-slide-content4').delay(1200).fadeIn();
        });	
...
function initialize() {
            ...
            var latlng = new google.maps.LatLng(12.754213,80.202545);
            var settings = {
                zoom: 16,
                center: latlng,
            ...
            var contentString = '<div id="content">'+
                '<div id="siteNotice">'+
                '</div>'+
                '<h2 id="firstHeading" class="firstHeading">SSN college of engineering</h2>'+
                '<div id="bodyContent">'+
                '<p>We are here!</p>'+
                '</div>'+
                '</div>';
            ...
            var companyImage = new google.maps.MarkerImage('images/marker.png',
                new google.maps.Size(70,67),<!-- Width and height of the marker -->
                new google.maps.Point(0,0),
                new google.maps.Point(35,25)<!-- Position of the marker -->
            );
    
            
    
            var companyPos = new google.maps.LatLng(12.75187,80.19753);
    
            var companyMarker = new google.maps.Marker({
                position: companyPos,
                map: map,
                icon: companyImage,               
                title:"SSN College of engineering , Computer science Department",
                zIndex: 3});
